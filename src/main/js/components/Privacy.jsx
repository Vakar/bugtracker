...
export default function Privacy() {
  return (
    <React.Fragment>
      <h1>Privacy Policy of bugtracker.vakar.space</h1>
      ...
      <p className="text-justify">
        ...
        but not limited to your name and email. The information that we collect
      ...
      <p className="text-justify">
        ...
        not hesitate to contact us by email: webmaster@vakar.space
      </p>
    </React.Fragment>
  );
}
